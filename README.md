...
The aim of the project was to develop a lightweight hand-tracking system, without the aid of neural-based AI, that allowed to control the mouse pointer using only the PC camera. The program is capable also of recognizing gestures to link them to the main mouse commands (e.g. click, drag, release).
